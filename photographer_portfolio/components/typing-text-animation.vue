<template>
    <div class="container">
        <h1>
            <span ref="typedText"
                class="custom-font-old-standard-regular text-emerald-800 text-4xl md:text-5xl xl:text-6xl">{{ typeValue
                }}</span>
            <span class="blinking-cursor text-4xl md:text-5xl xl:text-6xl text-emerald-800">|</span>
...
const displayTextArray = ref(["Photography", "Memories", "Moments", "Events"]);
let typingSpeed = 70;
let erasingSpeed = 70;
